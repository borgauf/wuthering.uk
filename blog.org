...
the Left has been hectoring, pushing the Average Janes and Joes, the
/Everyman/, the salt of the earth, yes, the /peasants/ to go too many
places they just couldn't go, to do too many things they just couldn't
do.
...
indeed these same Everyman types, when pushed too far, have a tendency
to "snap back." By that he means they will reach desperately,
spastically for a leader who promises immediate relief from the
dysphoria of having their status quo threatened, of having been pushed
too far leftward. How this gets triggered is, of course,
mysterious. As I've written before, humans are far less
"group-logical" and far more susceptible to herd stampede or
"freak-out" than we like to admit. That is to say, we collectively
...
common [[https://en.wikipedia.org/wiki/Deutscher_Michel][German /Michel/]] (over-)reacted strongly.

A result of this snap-back is invariably dictators who are very
impatient. If the vehicle of state has been going down Highway Wrong
Way at 120 mph, the dictator immediately throws the transmission into
reverse---with devastating results. But don't worry, Trump will not be
able to do this. There are still enough checks and balances to hold
him to a slower pace, if not block him entirely. How do I know this?
Read on.
...
into /Sturmabteilung/ Brownshirt street-thug paramilitaries.[fn:1]
...
principles that keep them "back" from modern times.[fn:2] But could a
whole society ever agree on which rules and principles to artificially
hold to? And with resources so liberalized,[fn:3] materialism so
...
its periodic famines, maxed-out forestry,[fn:4] harsh winters,
etc. Conservatism had to be the way of life. Tight resources equals
tight, rigid social behavior.[fn:5]
...
forma/, at best some nostalgic throwback, cosplay.[fn:6] This means
...
followers "everything that is sick about modern society."[fn:7] There
is a whole universe behind this simple-seeming pronouncement.

As you may know Goethe[fn:8] was the leading German intellectual and
...
irresponsible, off chasing "feelings," fairies in the forests,[fn:9]
...
mysteriously suspect, expectations seriously downgraded.[fn:10] Sure,
...
cancellation of /Enterprise/ in 2005.[fn:11] Odd how
...
are gripped by an anomie, an ennui of seemingly unknown origins.[fn:12]
...
Rings/ and /Harry Potter/, two vaguely medieval nostalgia trips.[fn:13]
...
"[[https://en.wikipedia.org/wiki/Cottagecore][Cottagecore]],"[fn:14] then I should not pretend to be like I'm Henry David
...
consequences.[fn:15] And so I want to get off the internet and avoid
screens...
...
[fn:1] Consider the January 6, 2020 Capitol uprising. Only a few
...
[fn:2] The Amish and Mennonites refer to themselves as /Die Stillen im
...
[fn:3] Consider the fact that you are consuming easily /one hundred
...
[fn:4] Think about it. The forest was the hypercritical base of
...
[fn:5] I'm always surprised that I seem to be the only person who has
made this connection, which has allowed me to understand the
foundation of conservatism.

[fn:6] Wherever there are Amish there are also Mennonites of various
...
[fn:7] It would be helpful to read my essay where I discuss the
Romantic Era. Click on the icon top left and click on /Preface./

[fn:8] [[file:images/GoetheWalk.jpg]] \\
...
[fn:9] ...as his contemporary Ludwig Tieck brought out in his "Big
Three" novellas: /Eckbert the Fair/, /The Elves/, and /Runenberg/
which were a cross of fairy tale and gothic lit.

[fn:10] Contrast /The Graduate/ with /2001: A Space Odyssey/ (1969),
which depicted human technological advancement as our quasi-mystical
destiny.

[fn:11] And no, /Star Wars/ was always just a "lite" version of
dystopian cyberpunk.

[fn:12] /anomie/: lack of the usual social or ethical standards in an
individual or group. \\
/ennui/: a feeling of listlessness and dissatisfaction arising from a
lack of occupation or excitement.

[fn:13] Most fail to see that the "wizarding world" was really just a
...
[fn:14] [[file:images/Taylor_Swift_Eras_Tour_Folklore_act_2.jpg]] \\
Taylor Swift up on the roof of her cottage in the forest---but not
really... \\
\\

[fn:15] There is no end to the hand-wringing of experts about the
