...
#+begin_export html
<img src="./images/Wuthering6.png" alt="title">
#+end_export
...
This has been a typical North Coast (NC) early Spring week of weather
confusion, sun one day, clouds the next, rain, sleet, atmospheric
instability. Suffice it to say, here April is not your friend. A very
low-ceiling misty-cloudy for the days---to suddenly open into the huge
heavens blue electric.
...
cloud-shrouded, with the very highest parts frosted. This is now just
a memory as the sun has blazed all day strongly.

The harbor is medium visibility, clouds hanging low. Sleet
come-and-go. Winds are moderate. Not like yesterday's, the 5th, when a
very strong north-east wind ripped across the sea.

#+begin_export html
<img src="./images/cloudridge20220406_1.png" width="730" alt="Clouded ridge">
<span class="cap">Clouded Sawtooth Ridge, April 6, 2022</span>
#+end_export
